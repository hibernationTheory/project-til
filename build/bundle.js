...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ContainerPage = __webpack_require__(216);
	...
	_reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        _reactRouter.Route,
	        { path: '/', component: _ContainerPage2.default },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainPage = function (_Component) {
		...
		function MainPage() {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MainPage).call(this));
		...
		_createClass(MainPage, [{
			...
			value: function componentDidMount() {
				var that = this;
				window.fetch('../resources/pages/gist_data_all.json').then(function (response) {
					if (response.ok) {
			...
			key: 'render',
			value: function render() {
				var elements = this.state.data.map(function (item) {
					console.log(item);
					return _react2.default.createElement(_Post2.default, { data: item });
				});
				return _react2.default.createElement(
					'div',
					{ className: '' },
	...
	var Post = function (_Component) {
		...
		_createClass(Post, [{
			...
			value: function rawMarkup(value) {
				return { __html: (0, _marked2.default)(value, { sanitize: true }) };
			}
		}, {
			key: 'render',
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'post' },
					_react2.default.createElement('div', { dangerouslySetInnerHTML: this.rawMarkup(item.content) })
				);
			}
		}]);
